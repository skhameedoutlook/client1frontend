...
export const Home = () => {
    return <div className="h-screen">
        ...
        <div className="flex flex-col justify-stretch items-center bg-slate-50 h-full">
          ...
          <div className="lg:w-7/12 sm:w-11/12 flex-grow p-3" style={HomeStyles}>
